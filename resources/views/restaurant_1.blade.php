        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul id="top-menu" class="nav navbar-nav navbar-right mu-main-nav">
                    ...
                    <li>@if(count($member_restaurants) <= 0)
                        <form action="{{ route('restaurant.subscribe') }}" method="POST">
                            ...
                            <font face="微軟正黑體"><button type="submit" class="btn btn-info-outline">訂閱！</button></font>
                        </form>
                    @elseif(count($member_restaurants) >= 0)
                        <font face="微軟正黑體"><button class="btn btn-info-outline" disabled>已訂閱</button></font>
                    @endif</li>
                </ul>
            </div>
            <!--/.nav-collapse -->
