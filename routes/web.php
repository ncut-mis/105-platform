...
/*餐廳搜尋-有會員版*/
Route::get('restaurant/search',['as' => 'restaurant.search' , 'uses' => 'RestaurantController@search_1']);
/*餐廳搜尋-無會員版*/
Route::get('restaurant/search_nom',['as' => 'restaurant.search_nom' , 'uses' => 'RestaurantController@search_2']);

/*餐廳頁面-有會員版*/
Route::get('restaurant/{id}/home' ,['as' => 'restaurant{id}.home' , 'uses' => 'RestaurantController@home_1']);
Route::post('member_restaurant/create' ,['as' => 'restaurant.subscribe' , 'uses' => 'RestaurantController@restaurant_subscribe']);
/*餐廳頁面-無會員版*/
...
Route::get('member/QRCode' ,['as' => 'member.QRCode' , 'uses' => 'MemberController@QRShow']);

//掃描QR頁面*/
Route::get('scanning', ['as' => 'scanning' , 'uses' => 'MemberController@scan']);

/*優惠卷*/
Route::get('member/coupon' ,['as' => 'coupon' , 'uses' => 'CouponController@index']);
...
Route::patch('personal/{id}/update' ,['as' => 'personal.modi.update' , 'uses' => 'MemberController@modiupdate']);
